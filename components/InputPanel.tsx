...
export const InputPanel: React.FC<InputPanelProps> = ({ state, onChange, onLoadExample, onCheck, hasStoredDraft, onRestoreDraft }) => {
  ...
  return (
    <div className="max-w-[1120px] mx-auto w-full px-6 space-y-10 animate-fade-in pb-12">
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 px-2 border-b border-stone-200 pb-8">
        <div className="space-y-1 shrink-0">
          <h2 className="text-5xl font-heading font-black text-black tracking-tighter whitespace-nowrap">Project Workspace</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
        ...
        >
          ...
          <div className="relative flex-grow min-h-[300px] flex flex-col bg-paper rounded-2xl border border-stone-200 focus-within:border-black transition-colors overflow-hidden">
            <textarea
            ...
            />
            <EmptyStateOverlay 
               isVisible={rubric.length === 0 && rubricFiles.length === 0}
        ...
        >
          ...
          <div className="relative flex-grow min-h-[300px] flex flex-col bg-paper rounded-2xl border border-stone-200 focus-within:border-black transition-colors overflow-hidden">
            ...
            />
            <EmptyStateOverlay 
               isVisible={essay.length === 0 && essayFiles.length === 0}
               title="Your Project"
      ...
      <div className="flex flex-col items-center pt-8 pb-6 px-8">
        <button
          ...
          className={`px-32 py-8 rounded-2xl font-heading font-black text-xl uppercase tracking-[0.3em] transition-all active:scale-[0.98] flex items-center justify-center gap-6 whitespace-nowrap ${
