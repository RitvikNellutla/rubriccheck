...
export const WelcomeModal: React.FC = () => {
  ...
  return (
    <div 
      className="fixed inset-0 z-[100] w-full h-full flex items-center justify-center p-4 bg-stone-900/60 backdrop-blur-sm overflow-y-auto"
      aria-modal="true"
      role="dialog"
      aria-labelledby="welcome-title"
    >
      <div className="bg-white max-w-lg w-full rounded-[2.5rem] shadow-2xl p-8 md:p-10 border border-stone-200 relative overflow-hidden transition-all transform animate-fade-in my-auto">
