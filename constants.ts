...
3. **Handle Visuals**: If the work is a presentation, look at the visual slides and design as well as the text. If a rule is about design (e.g., "Use high-quality images"), evaluate based on the visuals you see.
...
- **Lexical Hallmarks**: Use of "AI-isms" like 'delve', 'testament', 'tapestry', 'undisputed', 'pivotal', or 'multifaceted' in a generic context.
- **Syntactic Predictability**: Overly consistent sentence length (low burstiness) and a lack of grammatical 'flavor' or unique human error/flair.
- **Structural Formula**: Highly balanced "On one hand... on the other hand" structures or overly clean, three-point introductory outlines.
- **Perplexity**: Does the choice of words feel like the 'highest probability' next word, or does it show unique human vocabulary choices?
- **Logic Gaps**: AI often summarizes without deep insight. Human writing often has idiosyncratic connections.
...
- "exact_fix": Give a simple, clear instruction on how to fix the issue.
